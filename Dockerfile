...
FROM harbor.anpslab.com/library/devsecops/maven:3-jdk-8-slim as builder
...
FROM harbor.anpslab.com/library/devsecops/sles15sp3-openjdk:11.0-3.56.1 as runtime
EXPOSE 8080
